...
def showMovie(genre_id):
    # fetching all the movies based on genre
    ...
    return render_template('movie.html', movie=movie,
                           genre_name=genre_name, genre_id=genre_id)
...
def newMovie(genre_id):
    ...
    if request.method == 'POST':
        if not request.form['name']:
            flash("Please enter all the field")
            return redirect(url_for('newMovie', genre_id=genre_id))
